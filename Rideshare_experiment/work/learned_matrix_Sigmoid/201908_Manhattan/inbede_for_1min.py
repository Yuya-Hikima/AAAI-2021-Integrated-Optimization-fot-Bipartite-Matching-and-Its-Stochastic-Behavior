...
df = pd.read_csv("../green_tripdata_2019-08.csv",parse_dates=['lpep_pickup_datetime','lpep_dropoff_datetime'])
...
#gdf_ex_pu=df.values
df = pd.read_csv("../yellow_tripdata_2019-08.csv",parse_dates=['tpep_pickup_datetime','tpep_dropoff_datetime'])
df=pd.merge(df, df_loc, how="inner" ,left_on="PULocationID",right_on="LocationID")
df=df[(df["trip_distance"] >10**(-3))&(df["total_amount"] >10**(-3))&(df["borough"] == place)&(df["PULocationID"] < 264)&(df["DOLocationID"] < 264)]
...
with open('A_0_08', 'wb') as web:
  pickle.dump(A_0, web)
with open('b_0_08', 'wb') as web:
  pickle.dump(b_0, web)
with open('A_1_08', 'wb') as web:
  pickle.dump(A_1, web)
with open('b_1_08', 'wb') as web:
  pickle.dump(b_1, web)
with open('A_2_08', 'wb') as web:
  pickle.dump(A_2, web)
with open('b_2_08', 'wb') as web:
  pickle.dump(b_2, web)
with open('A_3_08', 'wb') as web:
  pickle.dump(A_3, web)
with open('b_3_08', 'wb') as web:
  pickle.dump(b_3, web)
with open('A_4_08', 'wb') as web:
  pickle.dump(A_4, web)
with open('b_4_08', 'wb') as web:
  pickle.dump(b_4, web)
